...
// Source: src/renderer/helpers/player/WebmSegmentIndexParser.js
// FreeTube's own header below describes its own adaptations from shaka-player.
//
...
import { EbmlParser } from './EbmlParser.js'
