...
// Source: src/renderer/helpers/player/SabrManifestParser.js
//
// Local changes:
//   - Removed FreeTube's `process.env.SUPPORTS_LOCAL_API` guard around the
//     ManifestParser auto-registration at the bottom of the file. Piped always
//     has the local SABR pipeline available.
//   - Import paths use the explicit `.js` extension for our build setup.

import shaka from 'shaka-player/dist/shaka-player.ui.js'
import { parseWebmSegmentIndex } from './WebmSegmentIndexParser.js'
import { parseMp4SegmentIndex } from './Mp4SegmentIndexParser.js'
