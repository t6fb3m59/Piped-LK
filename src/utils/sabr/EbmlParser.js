...
// Source: src/renderer/helpers/player/EbmlParser.js
// Originally adapted from shaka-player (https://github.com/shaka-project/shaka-player), Apache-2.0,
// which doesn't export its EBML parser.
//
// Local changes: none — file ported verbatim.
